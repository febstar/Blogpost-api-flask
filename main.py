...
class BlogForm(FlaskForm):
    ...
    url = StringField(label="Blog Image URL", validators=[InputRequired()])
...
def get_all_posts():
    ...
    Blogs = db.session.execute(db.select(BlogPost).order_by(BlogPost.title)).scalars().all()
    posts = [i for i in Blogs]
